  ...
  return (
    <div className='flex flex-col h-dvh items-center mx-auto justify-center max-w-7xl'>
      ...
      <div className='flex flex-col sm:flex-row min-h-96 xl:h-3/4 px-8'>
        <div className='min-w-96 xl:min-w-80 xl:max-h-8/12 xl:max-w-3xl max-sm:h-full relative min-h-7/8 xl:mr-8'>
          <Image
            fill
            objectFit='contain'
        ...
        <div className='leading-loose rounded-2xl text-left py-4 px12  bg-amber-100'>
